...
net8 = load_model(model+"8_1_10_rscp_distinguisher.h5",compile=False)

m7 = np.load(wrongKey+"data_wrong_key_mean_7r_1g_rscp.npy");
s7 = np.load(wrongKey+"data_wrong_key_std_7r_1g_rscp.npy"); s7 = 1.0/s7;

m8 = np.load(wrongKey+"data_wrong_key_mean_8r_1g_rscp.npy");
s8 = np.load(wrongKey+"data_wrong_key_std_8r_1g_rscp.npy"); s8 = 1.0/s8;
...
def run(n, nr=12, num_structures=100000, it=500, cutoff1=1, cutoff2=500, neutral_bits=[[20],[22],[13],[12,19],[14,21],[6,29]], keyschedule='real',net=net8, net_help=net7, m_main=m8, s_main=s8,  m_help=m7, s_help=s7, verify_breadth=None):
...
folder="./key_recovery_attack/2_8/"
# 写文件 'wb'：以二进制写模式打开文件
np.save(folder + 'run_sols1_'+'12_2_8_ncround.npy', arr1)
np.save(folder + 'run_sols2_'+'12_2_8_ncround.npy', arr2)
np.save(folder + 'run_good_'+'12_2_8_ncround.npy', good)
np.save(open('run_sols1_'+'2_8_nc.npy','wb'),arr1)
np.save(open('run_sols2_'+'2_8_nc.npy','wb'),arr2)
np.save(open('run_good_'+'2_8_nc.npy','wb'),good)
